        ...
        <nav class="navbar navbar-expand-lg navbar-light px-4 px-lg-5 py-3 py-lg-2">
            ...
            <div class="collapse navbar-collapse" id="navbarCollapse">
                <div class="navbar-nav ms-auto py-0">
                    ...
                    <a href="{{ route ('contact')}}" class="nav-item nav-link">Register</a>
        ...
        <div class="container-fluid bg-breadcrumb py-5  mb-5">
            <div class="container text-center py-5">
                <div class="row g-5 align-items-center">
                    <div class="col-lg-6">
                        <h4 class="text-white display-4 mb-4 wow fadeInDown" data-wow-delay="0.3s">Register and Join Us!</h4>
    ...
    <div class="container-fluid service py-3">
        <div class="container pb-3">
            <div class="text-center mx-auto pb-5 wow fadeInUp" data-wow-delay="0.2s" style="max-width: 800px;">
                ...
                <p class="mb-0">
                    Ready to make a difference? Whether you're donating, requesting help, or offering your time as a
                    volunteer, UniAid connects you with those who need it most. Choose your role and become part of our
                    mission to support communities across the Philippines.
                </p>
            </div>
