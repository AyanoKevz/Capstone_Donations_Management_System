                    ...
                    <div class="form">
                        <div class="details acct">
                            ...
                            <div class="fields">
                                ...
                                <div class="input-field">
                                    <label for="password">Password <span class="text-danger fs-6">*</span> <span
                                            class="icon-status"></span> </label>
                                    <input type="password" class="r-input" placeholder="Enter password" name="password">
                                </div>
                                <div class="input-field">
                                    <label for="cpassword">Confirm Password <span class="text-danger fs-6">*</span>
                                        <span class="icon-status"></span></label>
                                    <input type="password" class="r-input" id="cpassword"
