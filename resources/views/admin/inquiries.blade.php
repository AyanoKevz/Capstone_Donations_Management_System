              ...
              <div class="card card-primary card-outline">
                ...
                <div class="card-body p-0">
                  <div class="mailbox-controls d-flex justify-content-between align-items-center">
                    <!-- Check all button -->
                    <div>
                      <button type="button" class="btn email-btn btn-sm checkbox-toggle">
                        <i class="far fa-square"></i>
                      </button>
                      <div class="btn-group">
                        <button type="button" class="btn email-btn btn-sm">
                    ...
                    <div class="input-group" style="width: 300px;">
                      <input type="text" class="form-control form-control-sm" placeholder="Search Inbox">
                      <button class="btn email-btn btn-sm" type="button">
